...
/***/ function(module, exports, __webpack_require__) {
	...
	var _introCard = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof2 = __webpack_require__(331);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject    = __webpack_require__(317)
	  ...
	  , enumBugKeys = __webpack_require__(352)
	  , IE_PROTO    = __webpack_require__(306)('IE_PROTO')
	  , Empty       = function(){ /* empty */ }
	  , PROTOTYPE   = 'prototype';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(308)
	  ...
	  , toPrimitive    = __webpack_require__(323)
	  , createDesc     = __webpack_require__(324)
	  , _create        = __webpack_require__(342)
	...
	if(!USE_NATIVE){
	  ...
	  if(DESCRIPTORS && !__webpack_require__(338)){
	    redefine(ObjectProto, 'propertyIsEnumerable', $propertyIsEnumerable, true);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(308)
	  , core           = __webpack_require__(312)
	  , LIBRARY        = __webpack_require__(338)
	  , wksExt         = __webpack_require__(360)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.7 / 15.2.3.4 Object.getOwnPropertyNames(O)
	var $keys      = __webpack_require__(345)
	  , hiddenKeys = __webpack_require__(352).concat('length', 'prototype');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(312).Object.setPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(313)(Function.call, __webpack_require__(373).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
	        buggy = !(test instanceof Array);
	      } catch(e){ buggy = true; }
	      return function setPrototypeOf(O, proto){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(311)
	// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
	$export($export.S, 'Object', {create: __webpack_require__(342)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _badge = __webpack_require__(386);
	...
	var IntroCard = function (_React$Component) {
	  (0, _inherits3.default)(IntroCard, _React$Component);

	  function IntroCard() {
	    (0, _classCallCheck3.default)(this, IntroCard);
	    return (0, _possibleConstructorReturn3.default)(this, (IntroCard.__proto__ || (0, _getPrototypeOf2.default)(IntroCard)).apply(this, arguments));
	  }

	  (0, _createClass3.default)(IntroCard, [{
	    ...
	    key: 'onMouseOver',
	    value: function onMouseOver(word) {
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        { className: 'card' },
	        React.createElement(_badge2.default, { word: this.state.word }),
	        React.createElement(
	          'h1',
	          null,
	          'I\'m Jessie Jones'
	        ...
	        React.createElement(
	          'p',
	          null,
	          'Developer and maker, find me on:'
	        ),
	        React.createElement(
	          'p',
	          null,
	          React.createElement(_icon2.default, { name: 'github', onMouseOverEvent: this.onMouseOver.bind(this), onMouseOutEvent: this.onMouseOut.bind(this) }),
	          React.createElement(_icon2.default, { name: 'codePen', onMouseOverEvent: this.onMouseOver.bind(this), onMouseOutEvent: this.onMouseOut.bind(this) }),
	          React.createElement(_icon2.default, { name: 'twitter', onMouseOverEvent: this.onMouseOver.bind(this), onMouseOutEvent: this.onMouseOut.bind(this) })
	        )
	      );
	    }
	  }]);
	...
	var Badge = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Badge, [{
	    ...
	    value: function render() {
	      ...
	      var wordElement = React.createElement(
	        "h1",
	        { key: word },
	        word
	      );
	...
	var Icon = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Icon, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "a",
	        { href: "/", onMouseOver: this.onMouseOver.bind(this), onMouseLeave: this.onMouseOut.bind(this) },
	        React.createElement(
	          "svg",
